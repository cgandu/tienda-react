...
function generoItemConDatosRandom(i){
  const palabras = ["ANGELICA ZAPATA", "NIETO SENETINER", "LUIGI BOSCA", "FINCA LA LINDA", "CADUS", "MALBEC", "CABERNET SAUVIGNON", "CHARDONNAY", "SAUVIGNON BLANC", "MERLOT"];
  ...
  return {title: title, price: price, pictureName: `thumb-botella-${fotonum}.jpg`, stock: stock, desc: desc, id: id}
}
